...
$$
\begin{align}
i_{mixed} = \frac{1}{2} \left\{ \cos\left(\omega_st + \omega_ft\right) + \cos\left(\omega_st - \omega_ft \right) \right\}   \\
q_{mixed} = \frac{1}{2} \left\{ \sin\left(\omega_st + \omega_ft\right) + \sin\left(\omega_st - \omega_ft\right) \right\} \\
\end{align}
$$
